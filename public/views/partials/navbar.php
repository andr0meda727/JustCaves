...
<nav class="navbar">
  <div class="nav-container">
    ...
    <div class="logo-header">
      <svg width="35" height="28" viewBox="0 0 40 33" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M19.76 7.77563L32.3866 28.875H7.13336L19.76 7.77563ZM19.76 0L0 33H39.52L19.76 0Z" fill="#17CF17"/>
      </svg>
    ...
    <ul class="nav-links" id="nav-menu">
      ...
      <?php if ($isLoggedIn): ?>
        ...
        <li class="nav-icons-container">
          <a href="/profile" title="Mój profil" class="profile-icon">
